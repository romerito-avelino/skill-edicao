...
// EXTERNAL MODULE: ../skill-edicao/node_modules/remotion/dist/esm/index.mjs
var esm = __webpack_require__(5737);
// EXTERNAL MODULE: ../skill-edicao/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(6282);
;// ./src/compositions/KenBurns.tsx
...
const KenBurns = ({
  ...
  const progresso = frame / durationInFrames;
  const calcularTransform = () => {
    if (direcao === "zoom_in") {
      const escala = (0,esm.interpolate)(progresso, [0, 1], [1, intensidade]);
      return `scale(${escala})`;
    }
    if (direcao === "zoom_out") {
      const escala = (0,esm.interpolate)(progresso, [0, 1], [intensidade, 1]);
      return `scale(${escala})`;
    }
    if (direcao === "pan_direita") {
      const x = (0,esm.interpolate)(progresso, [0, 1], [0, -3]);
      return `scale(${intensidade}) translateX(${x}%)`;
    }
    if (direcao === "pan_esquerda") {
      const x = (0,esm.interpolate)(progresso, [0, 1], [0, 3]);
      return `scale(${intensidade}) translateX(${x}%)`;
    }
    return "scale(1)";
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#000", overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { opacity: opacidade }, children: [
    ...
    vinheta && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.AbsoluteFill,
      {
        style: {
    ...
    grain && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.AbsoluteFill,
      {
        style: {
...
;// ./src/compositions/FraseImpacto.tsx
...
const FraseImpacto = ({
  ...
  const opacidadeFundo = (0,esm.interpolate)(
    frame,
    [0, 10, durationInFrames - 10, durationInFrames],
    [0, 1, 1, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
  );
  const escalaLinha = (0,esm.interpolate)(frame, [0, 20], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const renderPalavras = () => {
    if (animacao === "palavra_por_palavra") {
      const framesPorPalavra = Math.max(
        1,
        Math.floor(durationInFrames * 0.7 / palavras.length)
      );
      return palavras.map((palavra, i) => {
        const frameInicio = i * framesPorPalavra;
        const op = (0,esm.interpolate)(frame, [frameInicio, frameInicio + 6], [0, 1], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
        const ty = (0,esm.interpolate)(frame, [frameInicio, frameInicio + 6], [12, 0], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
    ...
    if (animacao === "fade_bloco") {
      const op = (0,esm.interpolate)(frame, [0, 15], [0, 1], {
        extrapolateLeft: "clamp",
        extrapolateRight: "clamp"
      });
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { opacity: op }, children: texto });
    }
    if (animacao === "maquina_escrever") {
      const totalChars = texto.length;
      const charsVisiveis = Math.floor(
        (0,esm.interpolate)(frame, [0, durationInFrames * 0.7], [0, totalChars], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        })
      );
      const cursor = frame % 15 < 8 ? "|" : "";
      return /* @__PURE__ */ (0,jsx_runtime.jsxs)("span", { children: [
        texto.substring(0, charsVisiveis),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { opacity: 0.8 }, children: cursor })
      ] });
    }
    return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: texto });
  };
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#111", overflow: "hidden" }, children: [
    fundoUrl !== "" && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "img",
      {
        src: fundoUrl,
        style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: corFundo, opacity: opacidadeFundo } }),
...
;// ./src/compositions/FundoPadrao.tsx



const fundos = {
  madeira: {
    background: "linear-gradient(135deg, #2C1810 0%, #4A2C1A 40%, #3D2314 100%)",
    textura: "repeating-linear-gradient(90deg, transparent, transparent 2px, rgba(0,0,0,0.03) 2px, rgba(0,0,0,0.03) 4px)",
    vinheta: "radial-gradient(ellipse at center, transparent 40%, rgba(0,0,0,0.8) 100%)"
  },
  campo: {
    background: "linear-gradient(180deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)",
    textura: "none",
    vinheta: "radial-gradient(ellipse at center, transparent 50%, rgba(0,0,0,0.7) 100%)"
  },
  escuro: {
    background: "linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 100%)",
    textura: "none",
    vinheta: "radial-gradient(ellipse at center, transparent 60%, rgba(0,0,0,0.9) 100%)"
  },
  pergaminho: {
    background: "linear-gradient(135deg, #F5E6D3 0%, #E8D5B7 50%, #DEC5A0 100%)",
    textura: "repeating-linear-gradient(45deg, transparent, transparent 3px, rgba(0,0,0,0.02) 3px, rgba(0,0,0,0.02) 6px)",
    vinheta: "radial-gradient(ellipse at center, transparent 50%, rgba(139,90,43,0.5) 100%)"
  }
};
const FundoPadrao = ({
  texto = "",
  ...
  const escalaTexto = (0,esm.interpolate)(frame, [0, 20], [0.92, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const escalaLinha = (0,esm.interpolate)(frame, [15, 35], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const opacidadeSubtexto = (0,esm.interpolate)(frame, [25, 40], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { overflow: "hidden" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: fundo.background } }),
    fundo.textura !== "none" && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: fundo.textura } }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: fundo.vinheta } }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      esm.AbsoluteFill,
      {
        style: {
        ...
        children: [
          texto && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "p",
            {
              style: {
                color: corTexto,
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                marginTop: 28,
                height: 2,
                width: `${escalaLinha * 180}px`,
                backgroundColor: corDestaque,
                borderRadius: 1
              }
            }
          ),
          subtexto && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "p",
            {
              style: {
                color: corDestaque,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Composition,
      {
        ...
        height: 1080,
        defaultProps: {
          imagemUrl: "https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg",
          direcao: "zoom_in",
          intensidade: 1.08,
          vinheta: true,
          grain: false
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8130);
...
var Scheduler = __webpack_require__(2760),
  React = __webpack_require__(8130),
  ReactDOM = __webpack_require__(3171);
...
var React = __webpack_require__(8130);
function formatProdErrorMessage(code) {
  var url = "https://react.dev/errors/" + code;
  if (1 < arguments.length) {
    url += "?args[]=" + encodeURIComponent(arguments[1]);
...
if (true) {
  module.exports = __webpack_require__(4291);
} else // removed by dead control flow
{}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8130);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3596);
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5737);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5700);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6282);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(754), __webpack_require__.e(983)]).then(__webpack_require__.bind(__webpack_require__, 9754)).then(({ StudioInternals }) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8130);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3171);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6282);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "farm-opening:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfarm_opening"] = self["webpackChunkfarm_opening"] || [];
